...
### Step 1 ###
#Set up script for finding saved functions, outputs, and needed libraries. 
#This will include setting your working and output directories and sourcing your scripts.

### Step 2 ###
#Define parameters needed to run your model. Each parameter should have a 
#comment describing what that variable controls and (if needed) the range of values 
#the parameter can take. It is also a good idea to note if some variables should be 
...
### Step 4 ###
#Allow individuals to grow for 20 time units and to make choices about how long they 
#look for food and the quality of resources they accept. The choices individuals make 
#should change as individuals get larger.

### Step 5 ###
#Have the ability to change aspects of growth, food quality, and duration of seeking within the model.


### Step 6 ###
#Contain code that extracts needed information from simulation (e.g. it should output summaries 
#of what happened in  the model). There is no need to address this statistically at this step. 
